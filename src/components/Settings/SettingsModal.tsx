        ...
        <div className="modal-content">
          ...
          <div className="modal-header">
            <div className="flex items-center gap-3">
              <div className="logo-icon" style={{ width: '36px', height: '36px', fontSize: '0.875rem' }}>
              ...
              <>
                ...
                {activeTab === 'api' && (
                  <div className="space-y-6">
                    {/* Info Banner */}
                    <div className="flex items-start gap-3 p-4 rounded-lg" style={{ background: 'var(--accent-primary-light)' }}>
                      <svg className="w-5 h-5 flex-shrink-0 mt-0.5" style={{ color: 'var(--accent-secondary)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="form-group">
                      ...
                      <p className="text-caption mt-2">
                        Get your key from{' '}
                        <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)' }} className="hover:underline">
                    ...
                    <div className="form-group">
                      ...
                      <p className="text-caption mt-2">
                        Get your key from{' '}
                        <a href="https://console.anthropic.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)' }} className="hover:underline">
                ...
                {activeTab === 'preferences' && (
                  <div className="space-y-6">
                    {/* Default Deck Format */}
                    <div className="form-group">
                      <label className="form-label">Default Deck Format</label>
                      <select
                    ...
                    {/* Cards Per Page */}
                    <div className="form-group">
                      <label className="form-label">Cards Per Page</label>
                      <select
                    ...
                    {/* Theme - now managed by toggle in header */}
                    <div className="form-group">
